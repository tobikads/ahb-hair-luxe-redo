...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AHB Hair Extensions | Luxury Raw & Virgin Hair" },
      {
        name: "description",
        content:
          "AHB Hair Extensions — luxury raw virgin hair, HD lace wigs, bundles, closures and frontals designed to blend effortlessly and last beautifully.",
      },
      { name: "author", content: "AHB Hair Extensions" },
      { property: "og:title", content: "AHB Hair Extensions | Luxury Raw & Virgin Hair" },
      {
        property: "og:description",
        content: "Luxury hair extensions designed to blend effortlessly and last beautifully.",
      },
